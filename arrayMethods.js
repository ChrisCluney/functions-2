...
/*
  Use a higher order method to get all the order totals after adding in the sales tax (given to you as a tax rate, hint: you'll need to 
  do some multiplication). 
  Your answer should be an array of numbers, one total for each order.
*/

// const orderTotals = orders.map(fuction(element){
...
const bobsTotal = purchases.reduce((acc, element) => acc + element.price, 0) {
})
